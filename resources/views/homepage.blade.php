    ...
    <section class="slider">
        <div class="slick-carousel m-slides-0"
          ...
          <div class="slide-item align-v-h">
            <div class="bg-img"><img src="assets/images/sliders/rsud.jpg" alt="slide img" class="blur"></div>
            <div class="container h-100">
              <div class="row align-items-center w-100 h-100 m-0">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 h-100">
                  <img src="assets/images/sliders/rsud.jpg" alt="slide img" style="max-height:100%;width:100%">
                </div><!-- /.col-xl-7 -->
              </div><!-- /.row -->
            </div><!-- /.container -->
          </div><!-- /.slide-item -->
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-5">
              ...
              <div class="video-banner-layout2 bg-overlay">
                <img src="assets/images/about/pejabat.png" alt="about" class="w-100">
                <a class="video__btn video__btn-white popup-video" href="https://www.youtube.com/watch?v=pOGLk71MUAc">
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
              <div class="note font-weight-bold justify-content-between">
                <div>
                  <i class="far fa-file-alt color-primary"></i>
                  <span>Untuk Indonesia Sehat Sejahtera</span>
                </div>
                <a href="doctors-timetable.html" class="btn btn__link btn__secondary">
                  <span>Lihat Jadwal Dokter</span><i class="icon-arrow-right"></i>
                </a>
              </div>
            </div><!-- /.col-sm-6 -->
          </div><!-- /.row -->
