        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="post-item mb-0">
              <div class="post__img">
                <a href="#">
                  <img src="{{asset('assets/images/blog/single/1.jpg')}}" alt="post image" loading="lazy">
                </a>
              </div><!-- /.post-img -->
              ...
              <ul class="comments-list list-unstyled">
                <li class="comment__item">
                  <div class="comment__avatar">
                    <img src="{{asset('assets/images/blog/author/2.jpg')}}" alt="avatar">
                  </div>
                  ...
                  <ul class="nested__comment list-unstyled">
                    <li class="comment__item">
                      <div class="comment__avatar">
                        <img src="{{asset('assets/images/blog/author/3.jpg')}}" alt="avatar">
                      </div>
                      <div class="comment__content">
